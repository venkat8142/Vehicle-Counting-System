...
detect=[]   
offset=6 # Allowable error between piexel
counter=0 
...
while True:
    ...
    cv2.line(frame1,(300,count_line_position),(1400,count_line_position),(255,127,0),3)
    ...
    for (i,c) in enumerate(counterShape):
        ...
        for (x,y) in detect:
            if y<(count_line_position+offset) and y>(count_line_position-offset):
                counter+=1
            cv2.line(frame1,(25,count_line_position),(1150,count_line_position),(0,127,0),3)
            detect.remove((x,y))
